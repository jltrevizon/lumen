...
class GroupTaskRepositoryTest extends TestCase
{
    ...
    // {
    //     parent::setUp();
    //     $this->pendingTaskRepository = new PendingTaskRepository();
    //     $this->repository = new GroupTaskRepository([$this->pendingTaskRepository ]);
    // }
    ...
    //     $groupTask = GroupTask::factory()->create();
    //     $request = new Request();
    //     $request->replace(['group_task_id' => $groupTask->id]);
